...
{
    // Genera el PDF del reporte de ingresos y expone métodos de catálogo para la UI
    public class IngresosService
    {
        ...
        /// <summary>Genera el PDF del reporte de ingresos, lo guarda en disco y retorna la ruta.</summary>
            ...
            DateTime desde, DateTime hasta, int usuario_id)
        {
            ...
            string nombre_archivo = $"Ingresos_{nombreLimpio}_{desde:yyyyMMdd}_{hasta:yyyyMMdd}.pdf";
                ...
                container.Page(page =>
                {
                    ...
                    page.Content().Column(col =>
                    {
                        col.Item().PaddingVertical(10)
                            .Text("RESUMEN DEL REPORTE DE INGRESOS").Bold().FontSize(15).FontColor("#003399");
                        ...
                        col.Item().Text("DETALLE DE INGRESOS").Bold().FontSize(14).FontColor("#003399");
        ...
        // Métodos de catálogo que la UI necesita; delegan directamente al repositorio
