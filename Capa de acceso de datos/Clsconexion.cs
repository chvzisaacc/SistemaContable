...
namespace Capa_de_acceso_de_datos
{
    public class Clsconexion
    {
        ...
        string conexion = "Data Source=EDWINRODRIGUEZ;Initial Catalog=BD_Arquidiocesis;Integrated Security=True;TrustServerCertificate=True;";//Diego
        //string conexion = "Data Source=LAPTOP-D4F8GK1K\\MSSQLSERVER01;Initial Catalog=BD_Arquidiocesis;Integrated Security=True;TrustServerCertificate=True;";//Edwin
